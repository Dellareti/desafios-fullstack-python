...
class BeneficioDetalhe(BaseModel):
    ...
    nome_beneficio: str = Field(..., description="Nome do benefício (ex: Bolsa Família)")
    ...
    situacao: str = Field(..., description="Situação do benefício (ex: Pago, Cancelado)")
...
class ConsultaResponse(BaseModel):
    ...
    cpf: str | None = Field(default=None, description="CPF mascarado (ex: ***.456.789-**)")
